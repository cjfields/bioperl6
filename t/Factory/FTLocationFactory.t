...
my $simple_impl = Bio::Role::Location::Simple;
my $fuzzy_impl = Bio::Role::Location::Fuzzy;
my $split_impl = Bio::Role::Location::Split;
...
my %testcases = (
   ...
   "340..565" => [$simple_impl,
    ...
    "<345..500" => [$fuzzy_impl,
                    Any, 345, "BEFORE", 500, 500, "EXACT", "EXACT", 1, 1],
   "<1..888" => [$fuzzy_impl,
                 Any, 1, "BEFORE", 888, 888, "EXACT", "EXACT", 1, 1],
	"(102.110)" => [$fuzzy_impl,
    ...
    "?..>393" => [$fuzzy_impl,
        Any, Any, "UNCERTAIN", 393, Any, "AFTER", "UNCERTAIN", 1, 1],
    "<1..?" => [$fuzzy_impl,
        Any, 1, "BEFORE", Any, Any, "UNCERTAIN", "UNCERTAIN", 1, 1],
    "?..536" => [$fuzzy_impl,
        Any, Any, "UNCERTAIN", 536, 536, "EXACT", "UNCERTAIN", 1, 1],
    "1..?" => [$fuzzy_impl,
        1, 1, "EXACT", Any, Any, "UNCERTAIN", "UNCERTAIN", 1, 1],
    "?..?" => [$fuzzy_impl,
