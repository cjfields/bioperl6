...
Bio::RangeI - BioPerl Range interface
...
=head1 p5 IMPLEMENTATION AUTHOR - Heikki Lehvaslaiho

Email:  heikki-at-bioperl-dot-org

=head1 p6 IMPLEMENTATION AUTHOR - Chris Fields
...
=end disconnected_ranges

method disconnected_ranges { ... }
...
=begin offsetStranded

    Title    : offsetStranded
    Usage    : $rnge->offsetStranded($fiveprime_offset, $threeprime_offset)
